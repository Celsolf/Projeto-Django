...
class Candidato(models.Model):
    ...
    candidato_cpf =models.IntegerField(primary_key= True, unique=True)

    candidato_email =models.EmailField(default=0, unique=True)
    candidato_telefone =models.IntegerField(default=0, unique=True)
